...
export function AccountRestrictedScreen() { return <main className="mobile-prototype account-settings-screen"><Header title="계정 이용 제한" fallback="/intro" /><section className="account-processing"><h1>현재 계정의 이용이 제한되었어요.</h1><p>프로토타입 확인용 상태예요. 실제 서비스에서는 제한 사유와 문의 경로를 정책에 맞게 안내해야 해요.</p><button className="flow-primary-button" onClick={() => navigateTo("/intro")}>처음으로</button></section></main>; }
